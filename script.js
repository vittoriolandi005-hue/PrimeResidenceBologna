...
validCheckout(selectedStart,previewEnd)
){
return[selectedStart,previewEnd];
}
...
if(selectedStay){
selectedStay.classList.remove("visible");
}
...
/* SE ABBIAMO GIÀ UN RANGE COMPLETO
   IL CLICK CREA UN NUOVO CHECK-IN */
...
/* =========================================================
   ...
   IMPORTANTE:
   SE NON C'È STATO MOVIMENTO
   NON RIDISEGNIAMO IL CALENDARIO.
   COSÌ IL NORMALE EVENTO CLICK
   PUÒ PARTIRE SUBITO DOPO.
========================================================= */
...
validCheckout(dragStart,previewEnd)
){
...
/* SEMPLICE CLICK
   ...
   NON FARE renderCalendar() QUI.

   Il browser eseguirà subito dopo
   handleDayClick() sul pulsante originale.
*/
...
calendarResidenceTitle.textContent=residenceName;
}

if(calendarLiveText){
calendarLiveText.textContent="LOADING";
}

if(calendarLiveStatus){
calendarLiveStatus.classList.add("loading");
}

if(calendarLoadingMessage){
calendarLoadingMessage.classList.add("visible");
}
...
if(calendarLiveText){
calendarLiveText.textContent="LIVE";
}

if(calendarLiveStatus){
calendarLiveStatus.classList.remove("loading");
}

if(calendarLoadingMessage){
calendarLoadingMessage.classList.remove("visible");
}
...
if(calendarLiveText){
calendarLiveText.textContent="UNAVAILABLE";
}
